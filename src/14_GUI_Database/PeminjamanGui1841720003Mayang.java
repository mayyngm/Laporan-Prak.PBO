...
public class PeminjamanGui1841720003Mayang extends javax.swing.JFrame {

    /** Creates new form FrmPeminjaman */
    public PeminjamanGui1841720003Mayang() {
        initComponents();
        tampilDataMayang();
        kosongkanFormMayang();
    }
    ...
    public void tampilDataMayang(){
        ...
        ArrayList<Peminjaman1841720003Mayang> list = new Peminjaman1841720003Mayang().getAllMayang();
        Object rowData[] = new Object[5];

        this.tblPeminjaman.setModel(new DefaultTableModel(new Object[][]{}, kolom));
        for(int i = 0; i < list.size(); i++){
        rowData[0] = list.get(i).getmIdpeminjamanMayang();
        rowData[1] = list.get(i).getAnggotaMayang().getmNamaMayang();
        rowData[2] = list.get(i).getBukuMayang().getmJudulMayang();
        rowData[3] = list.get(i).getmTanggalPinjamMayang();
        rowData[4] = list.get(i).getmTanggalKembaliMayang();
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        Peminjaman1841720003Mayang pinjam = new Peminjaman1841720003Mayang().getByIdMayang(Integer.parseInt(this.txtId.getText()));
        pinjam.setAnggotaMayang(new Anggota1841720003Mayang().getByIdMayang(Integer.parseInt(this.txtIdAnggota.getText())));
        pinjam.setBukuMayang(new Buku1841720003Mayang().getByIdMayang(Integer.parseInt(this.txtIdBuku.getText())));
        pinjam.setmTanggalPinjamMayang(this.txtTanggalPinjam.getText());
        pinjam.setmTanggalKembaliMayang(this.txtTanggalKembali.getText());
        pinjam.saveMayang();
        tampilDataMayang();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        Peminjaman1841720003Mayang pinjam = new Peminjaman1841720003Mayang().getByIdMayang(Integer.parseInt(model.getValueAt(row, 0).toString()));
        pinjam.deleteMayang();
        kosongkanFormMayang();
        tampilDataMayang();
    ...
    private void btnCariAnggotaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariAnggotaActionPerformed
        // TODO add your handling code here:
        Peminjaman1841720003Mayang pinjam = new Peminjaman1841720003Mayang();
        pinjam.cariAnggotaMayang(Integer.parseInt(this.txtIdAnggota.getText()));
        this.jLabel6.setText((pinjam.getAnggotaMayang().getmNamaMayang()));
    ...
    private void btnCariBukuActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCariBukuActionPerformed
        // TODO add your handling code here:
        Peminjaman1841720003Mayang pinjam = new Peminjaman1841720003Mayang();
        pinjam.cariBukuMayang(Integer.parseInt(this.txtIdBuku.getText()));
        this.jLabel7.setText((pinjam.getBukuMayang().getmJudulMayang())); 
    ...
    private void tblPeminjamanMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblPeminjamanMouseClicked
        ...
        int row = this.tblPeminjaman.getSelectedRow();
        Peminjaman1841720003Mayang pinjam = new Peminjaman1841720003Mayang().getByIdMayang(Integer.parseInt(model.getValueAt(row,0).toString()));
        this.txtId.setText(String.valueOf(pinjam.getmIdpeminjamanMayang()));

        this.txtIdAnggota.setText(String.valueOf(pinjam.getmIdanggotaMayang()));
        this.txtIdBuku.setText(String.valueOf(pinjam.getmIdbukuMayang()));

        this.txtTanggalPinjam.setText(String.valueOf(pinjam.getmTanggalPinjamMayang()));

        this.txtTanggalKembali.setText(String.valueOf(pinjam.getmTanggalKembaliMayang()));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PeminjamanGui1841720003Mayang.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PeminjamanGui1841720003Mayang().setVisible(true);
            }
        });
    }
