...
public class Anggota1841720003Mayang {
    ...
    ArrayList<Anggota1841720003Mayang> getByNamaAndAlamatMayang(String nama, String alamat) {
        ...
        if ((nama.trim().length() > 0) && (alamat.trim().length() > 0)) {
            ...
            rs = DBHelper1841720003Mayang.selectQueryMayang("SELECT * FROM anggota Where nama = '"
            ...
            rs = DBHelper1841720003Mayang.selectQueryMayang("SELECT * FROM anggota Where alamat = '" + alamat + "'");
        ...
        try {
            ...
            while (rs.next()) {
                ...
                Anggota1841720003Mayang ang = new Anggota1841720003Mayang();

                ang.setmIdAnggotaMayang(rs.getInt("idanggota"));

                ang.setmNamaMayang(rs.getString("nama"));

                ang.setmAlamatMayang(rs.getString("alamat"));

                ang.setmTeleponMayang(rs.getString("telepon"));
